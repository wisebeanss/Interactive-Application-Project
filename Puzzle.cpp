...
int answer1;
char answer2 = ' ';
Puzzle::Puzzle() : InteractiveObject("puzzle",0, false)
{
    setCurrentRoom(0);
...
bool Puzzle::ROOMS(int roomID, Map& map,Player& player)
{
    ...
    if (roomID == 4)
    {
        ...
        if (spawned == false)
        {
            ...
            map.setObjects(new Suitcase(4, 8, 1,4));
