...
bool Puzzle::ROOM1(int roomID, Map& map)
{
    ...
    if (roomID == 1)
    {
        ...
        {
            map.clearObjects();
            map.setObjects(new Clocks("Clock1: The incident happened one hour after 10", 1, 4, 1));
            map.setObjects(new Clocks("Clock2: The minute hand stopped at 45.", 4, 4, 1));
            map.setObjects(new Clocks("Clock3: The second hand stopped at 12.", 1, 8, 1));
            map.setObjects(new Clocks("Clock4: This clock is 5 minutes faster than Clock 2.", 4, 8, 1));
            map.setObjects(new Mirrors("MirrorA: The reflection is smiling. But you are not", 16, 4, 1));
            map.setObjects(new Mirrors("MirrorB: You raise your left hand. The reflection raises its right hand", 21, 4, 1));
            map.setObjects(new Mirrors("MirrorC:You blink. It blinks with you.", 21, 8, 1));
