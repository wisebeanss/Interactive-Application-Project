...
#include<string>
using namespace std;
string entirescenes::FormatLine(const string& text, size_t width)
{
...
void entirescenes::Show()
{
    ...
    while (choice != 0)
    {
        ...
        cout << margin << "+---------------------------------+\n";
        cout << margin << "|                                 |\n";
        cout << margin << "|   1.  Start Game                |\n";
        cout << margin << "|   2.  How to Play               |\n";
        cout << margin << "|   3.  Credits                    |\n";
        cout << margin << "|   0.  Exit                       |\n";
        cout << margin << "|                                 |\n";
        cout << margin << "+---------------------------------+\n";
        cout << "\n" << margin << "   Enter your choice [0-3]: ";
...
void entirescenes::ShowCredits()
{
    DrawTitle();
    cout << "Credits content here...\n";
}
int entirescenes::ShowPauseMenu()
{
    system("cls");
    string margin(35, ' ');
    ...
    cout << margin << "+---------------------------------+\n";
    cout << margin << "|                                 |\n";
    cout << margin << "|   1.  Resume Game               |\n";
    cout << margin << "|   2.  Return to Main Menu        |\n";
    cout << margin << "|   0.  Exit Game                  |\n";
    cout << margin << "|                                 |\n";
    cout << margin << "+---------------------------------+\n";
